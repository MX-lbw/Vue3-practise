<template>
  <div class="center">
    <div class="your_scores_container">
      ...
      <p class="result_tip">耗时:{{ allTime }}秒</p>
    </div>
    ...
    <div class="share_cover" v-show="showHide" @click="showCover">
      <img :src="imgSrc" class="share_img" />
    </div>
  </div>
</template>
<script setup>
...
const { answerid, allTime } = store;
const score = ref(0); //分数
const scoreTips = ref(""); //分数提示
...
const imgSrc = "/src/assets/img/5-2.png";
...
function computedScore() {
  answerid.forEach((item, index, arr) => {
