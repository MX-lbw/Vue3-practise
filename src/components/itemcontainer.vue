...
const props = defineProps(["father-component"]);
const store = useStore();
const { level, itemNum, timer, itemDetail } = storeToRefs(store);

const choosedNum = ref(null); //选中答案索引
const choosedId = ref(null); //选中答案id
